...
function receiptCss(root){return `${root}{box-sizing:border-box;width:58mm;max-width:58mm;margin:0 auto;padding:0;background:#fff;color:#000;overflow:visible}${root} *{box-sizing:border-box;max-width:100%}${root} .receipt-content{width:48mm;max-width:48mm;margin:0 auto;padding:2mm 0 3mm;font-family:Arial,Helvetica,sans-serif;font-size:10px;font-weight:400;line-height:1.25}${root} .receipt-header{text-align:center}${root} .store-name{width:100%;max-width:100%;text-align:center;font-size:12px;font-weight:700;line-height:1.1;letter-spacing:0;white-space:nowrap}${root} .store-address,${root} .store-phone{font-size:9.5px;font-weight:400;line-height:1.25;white-space:nowrap}${root} .store-address{margin-top:1.5mm}${root} .store-phone{margin-top:1mm}${root} .receipt-divider{margin:1.5mm 0;border-top:1px dashed #000}${root} .receipt-row{display:grid;grid-template-columns:18mm minmax(0,1fr);column-gap:2mm;align-items:start}${root} .receipt-row .label,${root} .receipt-row .value{min-width:0;font-weight:400}${root} .receipt-row .value{text-align:right;overflow-wrap:anywhere;white-space:normal}${root} .customer-row{margin:1.7mm 0}${root} .customer-row .label,${root} .customer-row .value{font-weight:700}${root} .customer-row .value{overflow-wrap:break-word;word-break:normal;white-space:normal}${root} .receipt-item{margin:1.5mm 0;break-inside:avoid;page-break-inside:avoid}${root} .item-name{font-weight:400;overflow-wrap:anywhere}${root} .item-detail{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:2mm;font-weight:400}${root} .item-detail span{min-width:0;overflow-wrap:anywhere}${root} .item-detail span:last-child{text-align:right;white-space:nowrap}${root} .receipt-summary{break-inside:avoid;page-break-inside:avoid}${root} .total-row{margin:1mm 0;padding:1.2mm 0;border-top:1px dashed #000;border-bottom:1px dashed #000;font-size:12px}${root} .total-row .label,${root} .total-row .value{font-weight:700}${root} .receipt-footer{margin-top:2mm;text-align:center;font-size:9px;font-weight:400;line-height:1.3;overflow-wrap:anywhere;break-inside:avoid;page-break-inside:avoid}${root} .receipt-footer>div{margin-top:1.5mm}${root} .footer-message{white-space:nowrap}`}
