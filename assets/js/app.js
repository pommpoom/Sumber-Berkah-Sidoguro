...
function receiptCss(root){return `${root}{box-sizing:border-box;width:54mm;max-width:54mm;margin:0 auto;padding:1.5mm .5mm 2mm;background:#fff;color:#000;overflow:visible;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:400;line-height:1.12}${root} *{box-sizing:border-box;max-width:100%}${root} p,${root} h1,${root} h2{margin:0}${root} .receipt-content{width:100%;max-width:100%;margin:0;padding:0}${root} .receipt-header{text-align:center}${root} .store-name{text-align:center;font-size:16px;font-weight:700;line-height:1.05;letter-spacing:.1px}${root} .store-address,${root} .store-phone{text-align:center;font-size:10px;font-weight:400;line-height:1.12}${root} .store-address{margin-top:.7mm}${root} .store-phone{margin-top:.35mm}${root} .receipt-divider{margin:1mm 0;border-top:1px dashed #000}${root} .receipt-row{display:grid;grid-template-columns:20mm minmax(0,1fr);column-gap:1mm;align-items:start;margin:0;line-height:1.12}${root} .receipt-row .label,${root} .receipt-row .value{min-width:0;font-weight:400}${root} .receipt-row .value{text-align:right;overflow-wrap:break-word;word-break:normal;white-space:normal}${root} .customer-row{margin:1mm 0}${root} .customer-row .label,${root} .customer-row .value{font-weight:600}${root} .customer-row .value{overflow-wrap:break-word;word-break:normal;white-space:normal}${root} .receipt-item{margin:1mm 0;font-size:11px;break-inside:avoid;page-break-inside:avoid}${root} .item-name{margin:0;font-size:11.5px;font-weight:600;line-height:1.12;overflow-wrap:anywhere}${root} .item-detail{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:1mm;margin-top:.15mm;font-size:11px;font-weight:400;line-height:1.12}${root} .item-detail span{min-width:0;overflow-wrap:anywhere}${root} .item-detail span:last-child{text-align:right;white-space:nowrap}${root} .receipt-summary{font-size:11px;font-weight:400;line-height:1.13;break-inside:avoid;page-break-inside:avoid}${root} .total-row{margin:.8mm 0;padding:1mm 0;border-top:1px dashed #000;border-bottom:1px dashed #000;font-size:12.5px;line-height:1.1}${root} .total-row .label,${root} .total-row .value{font-weight:700}${root} .receipt-footer{margin-top:1.5mm;text-align:center;font-size:9.5px;font-weight:400;line-height:1.16;overflow-wrap:anywhere;break-inside:avoid;page-break-inside:avoid}${root} .receipt-footer>div{margin-top:1mm}${root} .receipt-footer>div:first-child{margin-top:0}`}
